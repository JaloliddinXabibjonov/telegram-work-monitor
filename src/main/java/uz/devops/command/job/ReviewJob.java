...
import static uz.devops.utils.Icons.EDIT_ICON;
import static uz.devops.utils.Icons.REMOVE_BASKET_ICON;
import static uz.devops.utils.MessageUtils.NO_WORKS_YET;
import static uz.devops.utils.MessageUtils.SET_TASK_JOB;
    ...
    public void execute(Update update) {
        var markupInline = newInlineKeyboardMarkup(
            List.of(
                ...
                newInlineKeyboardButton(SET_TASK_JOB, ADD_TASK_TO_JOB.getCommandName()),
