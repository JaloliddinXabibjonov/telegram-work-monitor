...
import static uz.devops.utils.BotUtils.newKeyboardRow;
...
public class StartCommand implements Processor {
    ...
    public void execute(Update update) {
        ...
        if (botUtils.userIsEmpty(update.getMessage().getChatId())) {
            keyboardRowList.add(newKeyboardRow(REGISTRATION.getCommandName()));
        }

        keyboardRowList.add(newKeyboardRow(ABOUT_BOT.getCommandName()));
