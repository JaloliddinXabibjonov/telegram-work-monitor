...
export class AlertService {
  ...
  success(translateKey: string, params?: any, isToast?: boolean): void {
    const alert: Alert = {
      type: 'success',
  ...
  info(translateKey: string, params?: any, isToast?: boolean): void {
    const alert: Alert = {
      type: 'info',
      translationKey: translateKey,
      translationParams: params,
  ...
  warning(translateKey: string, params?: any, isToast?: boolean): void {
    const alert: Alert = {
      type: 'warning',
      translationKey: translateKey,
      translationParams: params,
  ...
  danger(translateKey: string, params?: any, isToast?: boolean): void {
    const alert: Alert = {
      type: 'danger',
      translationKey: translateKey,
      translationParams: params,
