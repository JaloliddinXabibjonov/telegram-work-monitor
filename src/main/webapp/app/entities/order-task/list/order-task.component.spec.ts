...
describe('OrderTask Management Component', () => {
  let comp: OrderTaskComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(OrderTaskComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.orderTasks?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
