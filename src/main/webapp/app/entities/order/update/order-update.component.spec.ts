...
describe('Order Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Job query and add missing value', () => {
      ...
      const job: IJob = { id: 5775 };
      order.job = job;

      const jobCollection: IJob[] = [{ id: 87501 }];
    ...
    it('Should call TaskInfo query and add missing value', () => {
      const order: IOrder = { id: 456 };
      const taskInfo: ITaskInfo = { id: 59245 };
      order.taskInfo = taskInfo;

      const taskInfoCollection: ITaskInfo[] = [{ id: 126 }];
    ...
    it('Should update editForm', () => {
      const order: IOrder = { id: 456 };
      const job: IJob = { id: 2200 };
      order.job = job;
      const taskInfo: ITaskInfo = { id: 43764 };
      order.taskInfo = taskInfo;
