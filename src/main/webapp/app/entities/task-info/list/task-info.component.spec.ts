...
describe('TaskInfo Management Component', () => {
  let comp: TaskInfoComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(TaskInfoComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.taskInfos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
